    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          ...
          @endif
       <div class="card">
        <form id="form-add-teacher" action="/profile/{{ $user_id }}" method="post">
        @csrf
              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <input value="{{ $nim }}" type="text" class="@error ('nim') is-invalid @enderror form-control mb-2" name="nim" id="nim" placeholder="Enter NIM">                       
                    @error ('nim')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row">
              ...
              <div class="col">
                <div class="form-group">
                  ...
                  <input type="password" class="@error ('confirm_new_password') is-invalid @enderror form-control mb-2" name="confirm_new_password" id="confirm_new_password" placeholder="Confirm New Password">                       
